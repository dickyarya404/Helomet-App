...
if (isset($_POST["action"])) {
	if ($_POST["action"] == 'fetch') {
		...
		$main_query = "SELECT dt_report_id, SUM(dt_report_countusing) AS dt_report_countusing, SUM(dt_report_countnotusing) AS dt_report_countnotusing, dt_report_datetime 
		FROM tb_dt_report";
		...
		$result = $connect->query($main_query . $search_query . $group_by_query . $order_by_query . $limit_query);
